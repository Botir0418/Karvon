        ...
        <div class="row d-flex justify-content-between">
            <div class="col-12 col-md-7">
                ...
                <form action="/" method="post" class="col-10">
                    ...
                    <textarea cols="" rows="6" placeholder="Xabar matn yozing" required></textarea>
                    <button class="btn btn-primary" type="submit">Xabarni
                        yuborish</button>
                </form>
            </div>
            <div class="col-12 col-md-5">
                 <div>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d610.1792933750269!2d69.29655935588731!3d41.364615882833306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1suz!2s!4v1639754348841!5m2!1suz!2s"  allowfullscreen="" loading="lazy"></iframe>
                 </div>
                 <div class="info">
                     <h4>Aloqa uchun:</h4>
                     <h6>+998 99 123 45 67</h6>
                     <h6>info.karvon.uz@gmail.com</h6>
                     <h6>info.karvon.uz@gmail.com</h6>
                 </div>
                 <div class="info">
                    <h4>Ish vaqti:</h4>
